> **✅ RESOLVED (2026-06-15)** — Problem: A RateRule could set is_poa=True while also carrying a numeric price, a contradictory state. Fix: Added a constraint preventing is_poa=True from coexisting with a numeric price.
>
