> **✅ RESOLVED (2026-06-15)** — Problem: terms_accepted_at was required but had no default. Fix: The convert API now requires terms_accepted: true and stamps the timestamp server-side. Commit: c3523c6.
>
