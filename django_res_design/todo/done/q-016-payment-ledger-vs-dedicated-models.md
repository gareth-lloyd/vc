> **✅ RESOLVED (2026-06-15)** — Problem: Payment ledger versus a dedicated SecurityDeposit model? Fix: Decided Lane A (Payment-as-ledger with three per-purpose constraints) in 10-decisions.md. Commit: 8205bb7.
>
