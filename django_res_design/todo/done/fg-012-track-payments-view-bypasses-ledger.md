> **✅ RESOLVED (2026-06-15)** — Problem: The track-payments POST created ledger rows from request.data, mintable as SUCCEEDED. Fix: Routed it through ManualPaymentService so rows are born PENDING. Commit: 50d60e5.
>
