...
| **Deeper / Zoho-primary lead management** | Lead-management primacy settled Res-primary on the 2026-07-15 Limitless call (`decisions.md`; the M1 one-way push is now **GAP-081** — Zoho Flow webhooks, upsert-only, superseding the OAuth `ZohoSyncClient` design). Zoho-primary remains a v2 conversation. | `08-integrations.md`, `todo/done/gap-081-zoho-flow-outbound-push.md` |
