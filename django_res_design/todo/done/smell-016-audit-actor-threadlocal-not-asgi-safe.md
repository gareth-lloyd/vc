> **✅ RESOLVED (2026-06-15)** — Problem: Audit actor capture rode threading.local, which is not ASGI-safe. Fix: Switched to contextvars for ASGI-safe actor capture. Commit: ed1ce1d.
>
