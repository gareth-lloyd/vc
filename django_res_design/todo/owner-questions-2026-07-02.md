...
GAP-067/068 and have been removed from this round; see those tickets._
...
`../design/decisions.md`; retire this file to `reviews/` when the round closes.
...
Two short topics from building the new system — mostly confirming things
