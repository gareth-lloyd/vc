> **✅ RESOLVED (2026-06-15)** — Problem: Booking.adjustment recompute rode signals, so bulk writes left it desynced. Fix: Added a ConciergeService recompute for the bulk paths. Commit: 71b4bae.
>
