> **✅ RESOLVED (2026-06-15)** — Problem: How should rate cards with incomplete pricing behave? Fix: Decided: flag it and require a manual quote, per the legacy NO RATE behaviour.
>
