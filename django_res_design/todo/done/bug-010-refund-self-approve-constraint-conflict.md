> **✅ RESOLVED (2026-06-15)** — Problem: Refund self-approve permission conflicted with the separation-of-duties constraint, raising an IntegrityError 500. Fix: Dropped the SoD bypass from approve() while keeping it on execute().
>
