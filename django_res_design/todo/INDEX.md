...
| [GAP-039](gap-039-enquiry-dashboard-enrichment.md) | Enquiry list/dashboard enrichment to the Ben/owner mockup | 🟨 partial (2026-06-19) — read columns + lead_status/lost_reason exposure & filters, inline lead-status edit, salesperson/lead-status filters, page-size selector, stage tabs (excl. Dead/Converted). Remaining: inline salesperson/stage/lost-reason dropdowns, date-range filter UI, delete + select columns |
