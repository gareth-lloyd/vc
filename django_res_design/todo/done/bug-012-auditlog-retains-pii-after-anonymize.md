> **✅ RESOLVED (2026-06-15)** — Problem: AuditLog retained cleartext PII after anonymize()/merge(). Fix: Added core.audit.scrub_pii to redact PII from audit payloads. Commit: 5523546.
>
