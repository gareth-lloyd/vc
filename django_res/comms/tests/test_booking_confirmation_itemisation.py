...
def test_confirmation_itemises_charges_and_discounts(
    ...
    booking = _build_booking(
        property_=property_, customer=customer, gbp=gbp, terms=terms, with_charges=True
    )
...
def test_confirmation_without_charges_omits_the_block(
    ...
    sync_templates()
    booking = _build_booking(
        property_=property_, customer=customer, gbp=gbp, terms=terms, with_charges=False
    )
