> **✅ RESOLVED (2026-06-15)** — Problem: The security-deposit service raised bare ValueError, surfacing as 500s. Fix: Introduced typed InvalidSecurityDepositKind and added log_operation on the SD money path.
>
