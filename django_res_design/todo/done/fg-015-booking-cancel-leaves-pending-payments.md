> **✅ RESOLVED (2026-06-15)** — Problem: Booking.cancel was suspected of leaving PENDING Payment rows live. Fix: Confirmed cancel already bookkeeps the rows and added a regression test. Commit: b7157c5.
>
